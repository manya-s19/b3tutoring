  ...
  return <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        ease: 'easeOut'
          ...
          duration: 0.8,
          delay: 0.6
        }} className="text-xl sm:text-2xl md:text-3xl text-white/95 max-w-3xl leading-relaxed font-light">Expert one-on-one tutoring in Math, English, French, and Science. Personalized learning for <strong>Grades 4 to 12.</strong></motion.p>
