              ...
              <Link to="/gallery">
                <div className="h-full bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-white/20 hover:scale-105">
                  ...
                  <div className="mt-auto">
                    <div className="w-full py-3 bg-gradient-to-r from-white to-purple-50 text-purple-700 rounded-lg font-bold hover:bg-purple-100 transition-all duration-300 flex items-center justify-center">
                      View Gallery
                    </div>
                  </div>
                </div>
